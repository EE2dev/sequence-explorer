(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3'), require('d3-interpolate'), require('d3-array'), require('d3-scale')) :
    typeof define === 'function' && define.amd ? define(['exports', 'd3', 'd3-interpolate', 'd3-array', 'd3-scale'], factory) :
    (factory((global.sequenceExplorer = global.sequenceExplorer || {}),global.d3,global.d3,global.d3,global.d3));
}(this, function (exports,d3,d3Interpolate,d3Array,d3Scale) { 'use strict';
    ...
    function formatNumber(str, thousandsSeparator) {
    ...
    function orderDimension(dim) {
      if (typeof dim === "undefined") {
        ...
        /*
        return function(a, b) { 
          let first = dim.indexOf(a) - dim.indexOf(b);
          let bost = dim.indexOf(a) < dim.indexOf(b) ? -1 : dim.indexOf(a) > dim.indexOf(b) ? 1 : dim.indexOf(a) >= dim.indexOf(b) ? 0 : NaN;
          console.log(" [" + a + "," + b + "] - first: " + first + " bost:" + bost);
          return dim.indexOf(a) < dim.indexOf(b) ? -1 : dim.indexOf(a) > dim.indexOf(b) ? 1 : dim.indexOf(a) >= dim.indexOf(b) ? 0 : NaN;
         };
        */
      }
    }
