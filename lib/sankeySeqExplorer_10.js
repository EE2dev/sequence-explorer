        ...
        col.forEach( function (container, rowIndex) {
          ...
          .enter().append("path")
            ...
            .on("mousemove", function() {
              ...
              // var top = (d3.event.pageY - theight - 20 < 0) ? d3.event.pageY + 5 : d3.event.pageY - theight;
              // var left = (d3.event.pageX + twidth + 20 < window.innerWidth) ? d3.event.pageX + 5 : d3.event.pageX - twidth;
              var top = (d3.event.pageY - 100 < 0) ? d3.event.pageY + 5 : d3.event.pageY - theight;
