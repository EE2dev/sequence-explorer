        ...
        graph.nodes.forEach(function (d, i) {
          ...
          if (allGraphs.cols !== 1 && allGraphs.rows !== 1) { // two additional dimensions
            nInfos = nodeMap.get(dim2.key + "," + dim1.key + "," + xValue + "," + yValue);
              ...
              if (dim2.key !== "") { // dim2 = one dummy col dimension with just one value
                nodeMap.get(dim2.key + "," + dim1.key + "," + xValue + "," + yValue);
              } else {
                nInfos = nodeMap.get(dim1.key + "," + xValue + "," + yValue);
              }
          } else { // standard case
              if (dim1.key !== "") { // dim1 = one dummy rows dimension with just one value
                nInfos = nodeMap.get(dim1.key + "," + xValue + "," + yValue);
              }
              else {
