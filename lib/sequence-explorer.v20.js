(function (global, factory) {
    ...
    function particles() {
      ...
      */
      publicAPI.init = function (_svgPaths, _canvasTL, _pathName, _myPath, _sequenceStart, _linkMax, _linkValue, _particleMin, _particleMax, _particleSpeed, _particleShape, _particleSize, _nodeWidth) {
      ...
      function initializeCanvas(_canvasTranslate, _linkMax, _particleMin, _particleMax, _particleSpeed, _particleShape, _particleSize, _nodeWidth) {
        ...
        d3.select("svg.sankey").insert("canvas", ":first-child").attr("width", cw).attr("height", ch).attr("class", "particles");
    ...
    function sankeySeqExplorer (_myData) {
      ...
      function showRemoveParticles(_pathName) {
        if (!d3.select(this).node().checked) {
          ...
          myParticles = myParticles.init(classPaths.get(key), props.particleStart, _pathName, myPath, sequenceStart, mySankey.maxValue(), myPathValue, particleMin, particleMax, particleSpeed, particleShape, particleSize, nodeWidth).start();
        }
        return;
      }
